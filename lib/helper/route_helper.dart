import 'dart:convert';
import 'package:ServiceRaju/feature/auth/view/update_profile_screen.dart';
import 'package:ServiceRaju/feature/booking/view/repeat_booking_details_screen.dart';
import 'package:ServiceRaju/feature/checkout/view/offline_payment_screen.dart';
import 'package:ServiceRaju/feature/provider/view/nearby_provider/near_by_provider_screen.dart';
...
class RouteHelper {
  ...
  static const String toPage = 'cartScreen';
        ...
        page: () {
          ...
          return VerificationScreen(
            ...
            firebaseSession: Get.parameters['session'] == 'null'
                ? null
                : utf8
                    .decode(base64Url.decode(Get.parameters['session'] ?? '')), toPage: toPage,
          );
        }),
    GetPage(
        name: changePassword,
