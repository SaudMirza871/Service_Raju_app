      ...
      body: GetBuilder<HtmlViewController>(
        builder: (htmlViewController) {
          ...
          if (htmlViewController.pagesContent != null) {
            ...
            image = widget.htmlType == HtmlType.termsAndCondition
                ? htmlViewController.pagesContent?.images?.termsAndConditions ??
                    ""
                : widget.htmlType == HtmlType.aboutUs
                    ? htmlViewController.pagesContent?.images?.aboutUs ?? ""
                    : widget.htmlType == HtmlType.privacyPolicy
                        ? htmlViewController
                                .pagesContent?.images?.privacyPolicy ??
                            ""
                        : widget.htmlType == HtmlType.refundPolicy
                            ? htmlViewController
                                    .pagesContent?.images?.refundPolicy ??
                                ""
                            : widget.htmlType == HtmlType.cancellationPolicy
                                ? htmlViewController.pagesContent?.images
                                        ?.cancellationPolicy ??
                                    ""
                                : null;
