            ...
            child:
              ...
              CustomButton(
                ...
                onPressed: (widget.pageState == "payment" ||
                    ...
                    ? null
                    : () {
                  print("page state : ${widget.pageState} + ${checkoutController.currentPageState} + ${PageState.payment}");
                        if (errorText != null &&
                            ...
                            if (schedule == null &&
                              ...
                              customSnackBar(
                                ...
                                configModel.content?.scheduleBookingTimeRestriction ==
                                    1 &&
                                scheduleController.checkValidityOfTimeRestriction(Get.find<SplashController>().configModel.content!.advanceBooking!) !=
                                    null &&
                                scheduleController.selectedServiceType ==
                                    ServiceType.regular) {
                              ...
                              customSnackBar("select_time_hint".tr,
                                ...
                                scheduleController.selectedRepeatBookingType == RepeatBookingType.custom &&
