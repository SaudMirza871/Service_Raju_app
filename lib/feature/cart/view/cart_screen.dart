...
import 'package:ServiceRaju/feature/cart/widget/cart_product_widget.dart';
                                                                ...
                                                                : Get.find<SplashController>()
                                                                    ...
                                                                    : () {
                                                                        ...
                                                                        if (!Get.find<AuthController>()
                                                                          ...
                                                                          //     "cart"));
                                                                          Get.toNamed(
                                                                              RouteHelper.getSignInRoute(fromPage: "cart"));
                                                                        } else {
                                    ...
                                    : (Get.find<SplashController>()
                                        ...
                                        : () {
                                            if (!Get.find<AuthController>()
                                              ...
                                              Get.toNamed(
                                                  RouteHelper.getSignInRoute(fromPage: "toPage"));
                                            } else {
                                              Get.find<CheckOutController>()
                                                  .updateState(
